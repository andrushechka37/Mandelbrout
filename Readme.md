...
# mand1.cpp
## Это самый первый и наивный вариант программы, от которого мы будем мерить прирост производительности. Ниже для каждой версии представлена функция `get_color`  для высчитывания  цвета для каждого пикселя.
